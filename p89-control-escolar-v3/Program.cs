...
void Inicializar() {
    ...
    if(escuela is null) {
        ...
        salario:3400));
        escuela.AgregarProfesor(new Profesor(nombre:"Claudia Sid", fechaing:DateTime.Parse("1/4/2019"), grupo:"4B", materia:"Calculo",
        salario:3800));
        ...
        califs:new List<int> {8,8,8}));
        escuela.Profesores[0].AgregarAlumno(new Alumno( nombre:"Alicia Soto", edad:23, fechaing:DateTime.Parse("1/1/2018"), becado:true,
        califs:new List<int> {6,6,6}));
        escuela.Profesores[1].AgregarAlumno(new Alumno( nombre:"Maria Ochoa", edad:20, fechaing:DateTime.Parse("1/10/2018"), becado:true,
        califs:new List<int> {9,9,9}));
        escuela.Profesores[1].AgregarAlumno(new Alumno( nombre:"Carlos Diaz", edad:23, fechaing:DateTime.Parse("1/10/2018"), becado:false,
        califs:new List<int> {8,8,8}));
        escuela.Profesores[2].AgregarAlumno(new Alumno( nombre:"Jose Ochoa", edad:19, fechaing:DateTime.Parse("1/10/2016"), becado:false,
        califs:new List<int> {6,6,6}));
